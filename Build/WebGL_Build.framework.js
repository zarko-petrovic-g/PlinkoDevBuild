...
var ASM_CONSTS = {
  4115676: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4115731: function($0) {performance.now = function() { return $0; };},  
 4115779: function($0) {performance.now = function() { return $0; };},  
 4115827: function() {performance.now = Module['emscripten_get_now_backup'];},  
 4115882: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4115943: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4116007: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _UpdateSoundButton(isOn){
      var iconSound = document.querySelector(".iconSound");
...
var asmLibraryArg = {
  ...
  "IsAndroidWebGL": _IsAndroidWebGL,
  ...
  "UpdateSoundButton": _UpdateSoundButton,
